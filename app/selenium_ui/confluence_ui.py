...
"""
def test_1_selenium_csi_view_page_document_macro(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.app_specific_action_csi_view_page_document_macro(confluence_webdriver, confluence_datasets)

def test_1_selenium_csi_view_page_list_macro(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.app_specific_action_csi_view_page_list_macro(confluence_webdriver, confluence_datasets)

def test_1_selenium_csi_view_blog_document_macro(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.app_specific_action_csi_view_page_blog_document_macro(confluence_webdriver, confluence_datasets)

def test_1_selenium_csi_view_blog_list_macro(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.app_specific_action_csi_view_page_blog_list_macro(confluence_webdriver, confluence_datasets)
